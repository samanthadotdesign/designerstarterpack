INSERT INTO users (user_name, email, hashed_password, profession) VALUES 
('Samantha', 'hi@samantha.design', '1234', 'Product Designer'),
('Tong', 'tonglaphim@gmail.com', '1234', 'Product Manager');

INSERT INTO categories (category_name, category_img, section_id) VALUES
('Collaboration','../assets/categories/1_collaboration.svg', 1),
('Shape','../assets/categories/1_collaboration.svg', 2),
('Text', '../assets/categories/1_collaboration.svg',2),
('Frame', '../assets/categories/1_collaboration.svg', 2),
('Auto Layout','../assets/categories/1_collaboration.svg', 2),
('Styles','../assets/categories/1_collaboration.svg', 3),
('Components','../assets/categories/1_collaboration.svg',3),
('Design System','../assets/categories/1_collaboration.svg',3),
('Prototype','../assets/categories/1_collaboration.svg',4),
('Advanced Prototyping','../assets/categories/1_collaboration.svg',4),
('Design Ops','../assets/categories/1_collaboration.svg',5),
('Development','../assets/categories/1_collaboration.svg',5),
('Workshops','../assets/categories/1_collaboration.svg',6),
('Coding For Figma','../assets/categories/1_collaboration.svg',6),
('Figma Magic','../assets/categories/1_collaboration.svg',6);
...
('Animations', '/public/assets/skills/9_animations.svg', 9),
